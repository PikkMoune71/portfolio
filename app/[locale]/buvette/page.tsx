...
import { typedSkillsBuvette, categories } from "@/data/skills";
...
export default function Scrolly() {
  const images = [
    "/buvette.png",
    "/buvette/buvette-1.png",
    "/buvette/buvette-2.png",
    "/buvette/buvette-3.png",
  ];
  const t = useScopedI18n("buvette");
    ...
    <div className="m-auto py-8 px-6 max-w-5xl w-full relative">
      ...
      >
        {categories
          .map((category) => ({
            category,
            skills: typedSkillsBuvette.filter(
