import { File, Instagram } from "lucide-react";
...
export const SocialContact: React.FC<SocialContactProps> = (props) => {
  ...
  return (
    <div className="flex justify-start align-center gap-2">
      {props.github && (
        <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-10 w-10 px-0">
          <a
            target="_blank"
            rel="noreferrer"
            href="https://github.com/PikkMoune71"
          >
            <svg
      ...
      {props.linkedin && (
        <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-10 w-10 px-0">
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.linkedin.com/in/antoine-picard09/"
          >
            <svg
              fill="#0e76a8"
              strokeWidth="0"
      ...
      {props.instagram && (
        <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-10 w-10 px-0">
          <a
            target="_blank"
            rel="noreferrer"
            href="https://www.instagram.com/antoine.pic/"
          >
      ...
      {props.cv && (
        <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-10 w-10 px-0">
          <a target="_blank" rel="noreferrer" href="/CV-Antoine-Picard.pdf">
            <File style={{ width: iconSize, height: iconSize }} />
            <span className="sr-only">Instagram</span>
          </a>
        </button>
      )}
      {props.mail && (
        <>
          ...
          <a
            className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] text-sm font-semibold inline-flex items-center gap-2 hover:bg-primary/20 transition-colors hover:underline"
            href="mailto:antoinepicard385@gmail.com"
          >
            antoinepicard385@gmail.com
          </a>
        </>
      )}
    </div>
